  ...
  document.getElementById("mp1").style.visibility = "hidden";
  ...
  function starRating() {
    ...
    if (moves === 14) {
      ...
      starCount--;
      document.querySelector(".star")[0].style.animation = "stars-pulse 1s";
    }
    if (moves === 16) {
  ...
  function gameOver() {
      ...
      // play losing sound when all cards are matched and display modal 700ms after last match is made
      setTimeout(() => {
        let lose = new Audio("sounds/losing.mp3");
        displayModal2();
        lose.play();
      }, 800);
    }
  ...
  function AddStats() {
    ...
    if (starCount === 1) {
      ...
      p[1].innerHTML = `<strong> جووڵەی کراو</strong> ${moves} - جووڵەی زۆرت کرد`;
      p[2].innerHTML = `<strong> هەڵسەنگاندنەکەت</strong> ${starCount} لە 3 ئەستێرە ... !دەرچووی - خراپ نیە`;
    } else if (starCount === 2) {
      p[0].innerHTML = `<strong> کاتی تێچوو</strong> ${minutes} دەقە و ${seconds} چرکە`;
      p[1].innerHTML = `<strong> جووڵەی کراو</strong> ${moves}  دەرچووی -  باشبوویت`;
      p[2].innerHTML = `<strong> هەڵسەنگاندنەکەت</strong> ${starCount} لە 3 ئەستێرە ... `;
    } else if (starCount === 3) {
      p[0].innerHTML = `<strong> کاتی تێچوو</strong> ${minutes} دەقە و ${seconds} چرکە`;
      p[1].innerHTML = `<strong> جووڵەی کراو</strong> ${moves}`;
      p[2].innerHTML = `<strong> هەڵسەنگاندنەکەت</strong> ${starCount} لە 3 ئەستێرە ... <i class="fas fa-check-circle"></i> نایابە - مێشکێکی نایابە`;
    } else {
      p[0].innerHTML = `<strong> کاتی تێچوو</strong> ${minutes} دەقە و ${seconds} چرکە`;
      p[1].innerHTML = `<strong> جووڵەی کراو</strong> ${moves} - جووڵەی زۆرت کرد`;
      p[2].innerHTML = `<strong> هەڵسەنگاندنەکەت</strong> ${starCount} لە 3 ئەستێرە ... <i class="fas fa-times-circle"></i> دۆرای - باشتر هەوڵدە`;
    }
  ...
  function displayModal() {
    ...
    document.getElementById("title2").innerHTML="پیرۆزە";
    document.getElementById("par2").innerHTML= "توانیت هەر ٨ جووت بدۆزیتەوە";
   ...
   // create function that displays the modal when the game is lost

   function displayModal2() {
    // Access the modal <span> element (x) that closes the modal
    const modalClose = document.getElementsByClassName("close")[0];
    document.getElementById("title2").innerHTML="دۆرایت";
    document.getElementById("par2").innerHTML="نەت توانیت هەر ٨ جووت بدۆزیتەوە";
    const img_lose = document.getElementsByClassName("modal-img");
    img_lose[0].src="images/lose.png";
    const modal_block = document.getElementsByClassName("modal-content");
    modal_block[0].style="border: 0.8em solid rgb(255, 68, 68);"
